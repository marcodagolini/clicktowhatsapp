...
document.getElementById("mycontainer-waclick").innerHTML+= '

<div class="div-click-wa">

<p class="text-click-wa">Wanna talk with us through Whatsapp?</p>
<p class="text-click-wa">Give us your number!</p>


<div class="custom-select" style="width:150px; margin: 10px 5px 15px 10px; float:left;">
<select>
    <option value="0">Select code:</option>
    <option value="1">UK (+44)</option>
    <option value="2">Italy (+39)</option>
    <option value="3">Germany (+49)</option>
  </select>
</div>

<input type="text" class="wa-number" name="number">

<svg class ="wa-start" id="wa-number" style="display: block; margin: auto;"xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="55" version="1.1" viewBox="0 0 52.916668 14.552083">
 <defs>
  <clipPath>
